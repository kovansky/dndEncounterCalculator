...
//LErrorWindow is a controller function of Error View (dialog), but for Lorca instead of WebView. It creates a Lorca window
func LErrorWindow(ch chan int, model models.ErrorModel) {
	ui, _ := lorca.New("", "", 600, 220)
	defer ui.Close()
